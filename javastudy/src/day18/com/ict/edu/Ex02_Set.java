...
//		set 인터페이스는 구현한 클래스 : HashSet, TreeSet
...
//		1. 컬렉션 생성 (랩퍼클래스	:	기본 자료형을 클래스로 만들어주는 클래스들)
//					(Integer, Double, Character, Byte, String, Long)
...
//		2. 컬렉션에 객체 넣기(add)
		...
		System.out.println("\n하나씩 처리하기 (Iterator)");
		Iterator<Character> chit = h3.iterator();
		while (chit.hasNext()) {
			Character character = (Character) chit.next();
