...
//		1. 객체 만들기
		...
		Ex04_VO vo2 = new Ex04_VO("이길동", 21, "서울 용산구", false, 171.3);
		Ex04_VO vo3 = new Ex04_VO("김길동", 17, "서울 강남구", false, 172.6);
		Ex04_VO vo4 = new Ex04_VO("박길동", 33, "서울 서초구", true, 159.5);
		Ex04_VO vo5 = new Ex04_VO("홀길동", 26, "서울 중랑구", true, 189.8);
