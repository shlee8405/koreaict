 ...
 * 	HTML :	Hyper Text Markup Language	=> 하이퍼 텍스트 마트업 언어
...
public class Ex04_Parseing {
	public static void main(String[] args) {
		...
		//파일 쓰기
		String pathname = "D:"+File.separator+"shl"+File.separator+"오늘날씨.txt";
		...
		try {
			...
			Document document = builder.parse(in); //import from w3c.dom
